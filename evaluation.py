# Adapted from: https://github.com/uzh-rpg/rpg_ramnet/blob/master/RAM_Net/
...
def FLAGS():
    parser = argparse.ArgumentParser("""Evaluation for Hybrid MDE model""")
...
# Using metrics.eval_metrics, but that is specific for torch output
# Here below it is modified for numpy array
...
if __name__ == "__main__":
    ...
    if flags.event_masks != "": # SAT, is not -> !=
